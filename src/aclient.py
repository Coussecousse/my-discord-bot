    ...
    async def update_persona_and_daily_message(self):
        ...
        if now.hour == 9:
            ...
            if channel:
                try:
                    # Prompt pour l'IA
                    prompt = "Génère une message personnalisé pour l'anniversaire d'un membre du serveur discord qui s'appelle <@Voleur de heal> mais n'oublie pas ta personnalité."
